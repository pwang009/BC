...
namespace BlockChainCourse.BlockWithProofOfWork
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int levelOFDifficulty = 3;
            //create blocks
            IBlock block1 = new Block(0, keyStore, levelOFDifficulty);
            IBlock block2 = new Block(1, keyStore, levelOFDifficulty);
            IBlock block3 = new Block(2, keyStore, levelOFDifficulty);
            IBlock block4 = new Block(3, keyStore, levelOFDifficulty);
